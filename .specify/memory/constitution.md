...
- Added principles: Product Scope and Source of Truth; Explicit Trust Boundaries;
  Safe and Recoverable Local Lifecycle; Versioned Contracts and Data Privacy;
  Incremental Delivery with Proportionate Verification
- Added sections: Product and Engineering Constraints; Development Workflow
...
For an active change, its approved feature spec is the source of change intent;
...
approved scope. Non-trivial and user-visible work MUST begin with one Spec Kit
feature and measurable acceptance criteria. Architecture and security decisions
MUST be recorded before their implementation makes them expensive to reverse.
...
2. For non-trivial work, create one feature directory under `specs/`; do not
   create a parallel requirements/design/task hierarchy.
...
7. Update affected contracts, specs, ADRs, standards, and user-facing docs in the
   same change; show the diff before commit.

## Governance

This constitution governs all Spec Kit plans and reviews. `PROJECT_RULES.md`
operationalizes it but cannot weaken it. An amendment requires documented
rationale, a migration or compatibility note when existing work is affected, and
updates to dependent templates and guidance in the same change.
...
**Version**: 1.0.1 | **Ratified**: 2026-08-14 | **Last Amended**: 2026-08-15
